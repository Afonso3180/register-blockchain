...
contract myRegister{
    ...
    /*CONSTRUCTOR*/   //inicializando ao fazer o deploy do contrato
    address owner;
    constructor() public{
        owner = msg.sender;
    }
    ...
    function allUser() public view returns (uint length){
    ...
    function getUser(string memory _id) public view returns (string memory userObtido){
        ...
        if(tempEmptyStringTest.length != 0){
            a = string(string(abi.encodePacked("O nome do usuario é ",c.nome,", ", "de ", c.idade," anos", ", ","detentor do cpf: ",c.cpf," e desempenha a função de ", c.cargo, ".")));
        }else
